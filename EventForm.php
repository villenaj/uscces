	...
	<div class="main-w3layouts wrapper">
		<div class="main-agileinfo">
			<div class="agileits-top">
                ...
                <a href='ViewEvents.php'><font color="#1a1aff">View Events</a><br></font>
				...
				<textarea placeholder="Type event details" id="details" name="details" rows="4" cols="30"></textarea><br>
