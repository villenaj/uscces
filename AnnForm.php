	...
	<div class="main-w3layouts wrapper">
		<div class="main-agileinfo">
			<div class="agileits-top">
                ...
                <a href='ViewAnnouncement.php'><font color="#1a1aff">View Announcement</a><br></font>
                ...
                <input type="text" class="user" name="Empname" value="<?php echo $Fname." ".$Lname;  ?>" readonly><br>
				  ...
				  <textarea placeholder="Type announcement details" id="details" name="details" rows="4" cols="30"></textarea><br>
